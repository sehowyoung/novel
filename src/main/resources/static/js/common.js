...
function Login() {
    if (jieqiUserId != 0 && jieqiUserName != '' && (document.cookie.indexOf('PHPSESSID') != -1 || jieqiUserPassword != '')) {
        document.write('Hi,<a href="/userdetail.php" target="_top">' + jieqiUserName + '</a> | <a href="/logout.php" target="_self">退出登录</a>');
    } else {
        document.writeln("<a href=\"/login.php\">登录</a>、<a href=\"/register.php\">注册</a>");
    }
    document.writeln("<br><a target=\"_blank\" class='red' href=\"https://m.xbiquge.so/\">手机阅读</a>");
}

// 底部文字说明
function foot() {
    document.writeln("<p>本站所有小说为转载作品，所有章节均由网友上传，转载至本站只是为了宣传本书让更多读者欣赏。</p>");
    // document.writeln("<p>Copyright &copy; " + new Date().getFullYear() + " <a href=\"https://www.xbiquge.so\">笔趣阁</a>(www.xbiquge.so)  All Rights Reserved.</p>");
};
